...
**Goal:** 50–100 genuine waitlist signups in ~2 weeks. Below: ready-to-paste posts. Replace `[LIVE-URL]` with your Netlify URL everywhere before posting.
...
>
> Try it (no signup, 2 minutes): [LIVE-URL]
>
...
>
> No signup needed to play: [LIVE-URL]
>
...
> Built a small free interactive bug-hunt exercise (boundary analysis + a 3-bug signup form) as a pilot for a hands-on QA learning platform. Would love feedback from experienced testers on whether the seeded bugs feel realistic: [LIVE-URL]
...
> 🐞 Quick challenge: this signup form has 3 hidden bugs. Most people find 0. Can you find all 3? Takes 2 min, no signup: [LIVE-URL]
...
- [ ] `[LIVE-URL]` replaced in every post above
